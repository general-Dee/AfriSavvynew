...
function Projects() {
    const projects = [
        {
            ...
            discription: "When you partner with EdenMart, you’re not alone in your journey. We provide full marketing support to help you succeed. This includes we sending you a list of customers that will buy this product from you, which saves you cost on advertising. We also offer training on how to effectively communicate with the customers that we will be sending you to purchase our products which will altimately grow your business. Our team will keep you updated on the latest tactics and strategies to help you stay competitive in the market. Whether you’re a seasoned seller or just starting out, we’re here to provide guidance and resources to help your business thrive."
        },
        {
            title: "Lucrative Profit Margins",
            displayImg: "./img/benefit02.jpg",
            discription: "As a distributor with EdenMart, you’ll enjoy competitive profit margins on every product you sell. We believe in rewarding our partners, so we’ve designed our program to maximize your earnings. Whether you're just starting or looking to expand your current business, our pricing structure ensures that you can maintain a profitable venture while delivering high-quality products to your customers. With transparent pricing and no hidden costs, you'll know exactly how much you’re earning with each sale."
        },
        {
            title: "High-Quality, In-Demand Products",
            displayImg: "/img/benefit03.jpg",
            discription: "EdenMart offers a curated selection that are not only trusted but also highly sought after in the market. Our products meet the highest standards in safety, quality, and effectiveness, ensuring that you’ll always have something that your customers want. We provide products that cater to a wide range of needs. Distributing trusted and well-loved products means your customers will keep coming back, building a loyal customer base for your business."
        },
        {
  ...
  return (
    ...
    className='h-screen flex relative overflow-hidden flex-col text-left md:flex-row max-w-full justify-evenly mx-auto items-center z-0'>
        <h3 className='absolute top-24 uppercase tracking-[20px] text-gray-500 text-2xl text-center'>Why Become Our Distributor?</h3>
        ...
        <div className='relative w-full flex overflow-x-scroll pt-40  snap-x snap-mandatory scrollbar  overflow-y-hidden z-20 scrollbar-track-gray-400/20 scrollbar-thumb-[#7FAB0A]'>
