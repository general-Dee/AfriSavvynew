  ...
  return (
    <motion.div 
        ...
        <div className="space-y-10 px-0 md:px-10">
            ...
            AfriSavvy is a pioneering e-commerce platform focused on providing high-quality products to customers across Nigeria and beyond. We are more than just a marketplace; we are a community dedicated to enriching lives through premium products and exceptional service. As we grow, we are actively seeking partners who share our vision and are ready to capitalize on the booming e-commerce market in Africa. By joining UrbanSavanna as a distributor, you become part of a dynamic network that prioritizes innovation, quality, and customer satisfaction. Together, we can build a profitable and sustainable business that meets the evolving needs of modern consumers across the continent.
            </p>
            {/* <p className="text-base">
